        ...
        <div class="col-lg-3">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <span
                        class="badge badge-{{ $user->hasRole('admin') ? "danger" : "success"}} float-right">{{ $user->getRoleNames()->first() }}</span>
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('profile.editpassword', $user) }}" class="btn btn-info d-block mb-2">Change
                        Password</a>
