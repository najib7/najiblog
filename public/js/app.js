...
$(function () {
  ...
  var submitButton = $('#submit-button'); // create new category
  ...
  $(document).on('click', '.edit-category', function (event) {
    ...
    var cateogry = $(this).data('category');
    formCategory.trigger('reset');
  ...
  submitButton.click(function (event) {
    event.preventDefault();
    var category = formCategory.find('input[name="name"]');
    var description = formCategory.find('textarea[name="description"]');
    var data = {
      'name': category.val(),
        ...
        success: function success(response) {
          if (response.status === 'success') {
            ...
            $.each(response.message, function (key, value) {
              $("<span class=\"text-danger validate\">".concat(value[0], "</span>")).insertAfter(formCategory.find("*[name=\"".concat(key, "\"]")));
            });
          }
        },
  ...
  $(document).on('click', '.delete-category', function (event) {
    ...
    Swal.fire({
      title: "Delete '".concat(category.name, "' category."),
      text: 'Are you sure?',
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#d33',
      ...
      if (result.value) {
        $.ajax({
          url: "/api/categories/".concat(category.id),
          type: "DELETE",
          success: function success(response) {
            if (response.status === 'success') {
              Swal.fire('Deleted!', response.message, 'success').then(function (result) {
                if (result.value) {
                  window.location.reload();
                }
              });
  ...
  var formComment = $('#form-comment'); // edit comment
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (response.status === 'success') {
          ...
          $("<span class=\"text-danger validate\">".concat(response.message.comment[0], "</span>")).insertAfter(formComment.find("*[name=\"comment\"]"));
        }
      }
    });
  });
...
__webpack_require__(/*! /home/najib/projects/najiblog/resources/js/app.js */"./resources/js/app.js");
__webpack_require__(/*! /home/najib/projects/najiblog/resources/sass/app.scss */"./resources/sass/app.scss");
__webpack_require__(/*! /home/najib/projects/najiblog/resources/sass/blog.scss */"./resources/sass/blog.scss");
module.exports = __webpack_require__(/*! /home/najib/projects/najiblog/resources/sass/dashboard.scss */"./resources/sass/dashboard.scss");
